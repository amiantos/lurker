...
- **Native Apps.** Lurker has official native apps [for iOS](https://github.com/amiantos/lurker-ios) (in beta) and Android (coming soon). There are also third-party clients such as [Spooky](https://github.com/JawshTheDark/lurker-android-upstream) (Android), [Scully](https://github.com/JawshTheDark/scully) (GTK4), and [luir](https://luir.org) (TUI), which bring their own flavor to Lurker.
